...
public class  BranchSession  {
    ...
    public static  String e_nombregrabacion="";
    public  static  String e_nombrearchivoaudio="";
    public  static  String e_isclient="";

    public static String getE_isclient() {
        return e_isclient;
    }

    public static void setE_isclient(String e_isclient) {
        BranchSession.e_isclient = e_isclient;
    }

    public static String getE_nombrearchivoaudio() {
        return e_nombrearchivoaudio;
    }

    public static void setE_nombrearchivoaudio(String e_nombrearchivoaudio) {
        BranchSession.e_nombrearchivoaudio = e_nombrearchivoaudio;
    }

    public static String getE_nombregrabacion() {
        return e_nombregrabacion;
    }

    public static void setE_nombregrabacion(String e_nombregrabacion) {
        BranchSession.e_nombregrabacion = e_nombregrabacion;
    }
