...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent intent) {
        ...
        switch (requestCode) {
            ...
            case RequestCodes.IMAGE_CHOOSER:
                ...
                File root = new File(Environment.getExternalStorageDirectory().getPath() + "/Call Recorder/" + objBranchSessioot.getE_code()+"_"+objBranchSessioot.getE_name()+".mp3");
    ...
    private View createView(int event, boolean advancingPage) {
        ...
        switch (event) {
            case FormEntryController.EVENT_BEGINNING_OF_FORM:
                ...
                BranchSession objBranchSessioot=new BranchSession();
                try{
                    MainActivityllamadas objllamadas= new MainActivityllamadas();
                    String llamadatime= objllamadas.consultarCPLlamadasFormulario(objBranchSessioot.getE_Phone(),getApplicationContext());
                    objBranchSessioot.setE_nombregrabacion("");
                    objBranchSessioot.setE_nombregrabacion(llamadatime);
                }catch (Exception ex){
    ...
    private void showNextView() {
        ...
        try {
            ...
            MainActivityllamadas objllamadas= new MainActivityllamadas();
            String llamadatime= objllamadas.consultarCPLlamadasFormulario(objBranchSessioot.getE_Phone(),getApplicationContext());
            String llamadatelf= objllamadas.consultarCPLlamadasFormulario(objBranchSessioot.getE_idprovince(),getApplicationContext());
