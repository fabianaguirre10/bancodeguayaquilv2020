...
public class DownloadFormListUtils {
    ...
    public HashMap<String, FormDetails> downloadFormList(@Nullable String url, @Nullable String username,
        ...
        //cambio para cambiar la descarga en la base de datos
        //fabian agurirr
        if( !Collect.getInstance().getString(R.string.default_server_url).equals("http://geomardis6728.cloudapp.net:8080/odk_bg")){
            downloadListUrl="http://geomardis6728.cloudapp.net:8080/odk_bg";
        }
