    ...
    protected File doInBackground(Uri... uris) {
        ...
        if (formController != null) {
            ...
            if (instanceFile != null) {
                ...
                objBranchSessioot.setE_nombregrabacion(System.currentTimeMillis() + extension);
                String destMediaPath = instanceFolder + File.separator + objBranchSessioot.getE_nombregrabacion();
